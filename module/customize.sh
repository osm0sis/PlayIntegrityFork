...
if [ -f /data/adb/modules/playintegrityfix/scripts-only-mode ]; then
    ...
    rm -rf $MODPATH/action.sh $MODPATH/app_replace_list.txt \
        ...
        /data/adb/modules/playintegrityfix/skipmatchmode \
...
for FILE in custom.app_replace_list.txt custom.pif.json custom.pif.prop skipdelprop skipmatchmode skippersistprop uninstall.sh; do
